...
for filepath in filepaths:
    ...
    # Add a header
    columns = df.columns  # Não é uma lista mas é iterável (é um Index)
    ...
    pdf.cell(w=30, h=8, txt=f"The total price is: {sum_total_price}", ln=1)

    # Add company name and logo
    pdf.set_font(family="Times", size=14, style="B")
    pdf.cell(w=35, h=8, txt="PythonMarshal")
